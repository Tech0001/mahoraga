...
- Arm criteria: Director calibrates setup labels against real charts (tomorrow's open), then flips the flag together. Remaining build: LLM catalyst check on premarket watchlist.
